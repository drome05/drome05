...
**[OneSelf](https://github.com/drome05/OneSelf)** — life tracking mobile app `in development`  
...
Discord bot managing competitive lobbies, queues, and match coordination for organized Valorant play.  
`Python` `Discord API`
